 ...
 **Важно:**
        ...
        - В прокторинге есть сущность, которая отвечает за "комнаты". Запись привязана к комнате (ссылка на экзамен).
        - Ссылка выдается преподавателем перед началом экзамена.
...
4. После выдачи всех разрешений система сообщит о готовности к записи с небольшой информацией о работе расширения.
    ...
    Также на вкладке появится предпросмотр: экрана и камеры. Предпросмотр работает в режиме live трансляции. Пожалуйста не пугайтесь страшной рекурсии на экране, так и должно быть.
